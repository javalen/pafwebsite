...
const Navbar = ({ handleLogoutPopup }) => {
  return (
    <div className="shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200 relative z-40">
      {/* upper Navbar */}
      <div className="bg-bg-background/40 py-2">
        <div className="container flex justify-between items-center">
          <div>
            <a href="#" className="grid font-bold text-2xl sm:text-3xl flex gap-2 justify-items-center justify-items-center content-center content-stretch self-center">
